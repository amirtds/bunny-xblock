        ...
        fragment.initialize_js(
            "BunnyAuthorView",
            {
                ...
                "endpoints": {
                    ...
                    "captions": "/api/xblock_bunny/videos/{guid}/captions",
                    "captionDelete": "/api/xblock_bunny/videos/{guid}/captions/{srclang}",
                    "transcribe": "/api/xblock_bunny/videos/{guid}/transcribe",
                    "chapters": "/api/xblock_bunny/videos/{guid}/chapters",
